...
const defaultHeaders = {
  ...
  'Origin': 'https://fancytl.com', // usually required for CORS
  'Pragma': 'no-cache',
  'Referer': 'https://fancytl.com/', // sometimes required
  'Site-Domain': 'fancytl.com', // custom API header
  'User-Agent':
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/141.0.0.0 Safari/537.36',
};

class FancyTLPlugin implements Plugin.PluginBase {
  id = 'FancyTL';
  name = 'FancyTL';
  site = 'https://api.mystorywave.com/story-wave-backend/api/v1/';
  version = '1.0.0';
  icon = 'src/en/fancyTL/favicon.png';
...
export default new FancyTLPlugin();

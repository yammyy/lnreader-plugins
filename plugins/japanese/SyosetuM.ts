...
class syosetuMEN18Plugin implements Plugin.PluginBase {
  id = 'syosetuMEN18';
  name = 'Syosetu 18+ ♂ (ノクターンノベルズ)';
  icon = 'src/jp/syosetu/iconM.png'; // reuse or change if needed
  site = 'https://noc.syosetu.com/';
  novelPrefix = 'https://novel18.syosetu.com/';
  popularPrefix = 'https://noc.syosetu.com/';
  searchPrefix = 'https://noc.syosetu.com/search/';
  version = '1.0.1';
  headers = {
    'User-Agent':
...
export default new syosetuMEN18Plugin();
